  ...
  return (
    ...
    >
      <SubSection
        ...
        description="Sidebar com todas as seções: logo, org switcher, itens de navegação agrupados (com sub-itens expansíveis) e footer com dados do usuário. Clique em 'Missões' para ver o expand/collapse."
      >
      ...
      >
        <ul className={s.anatomyList}>
          ...
          <li className={s.anatomyItem}>
            <span className={s.anatomyCode}>SidebarHeader</span> — área do logo no topo
          </li>
          <li className={s.anatomyItem}>
